void LED_DISPLAY() {
  switch (SCREEN) {
    case 1:
      switch (TIMER) {
        case 1:
          ...
          break;
        case 2:
          V_DISP.setDisplayToString("OFt");
          A_DISP.setDisplayToDecNumber(MIN_DISPLAY, 0, false);
          break;
        case 3:
          V_DISP.setDisplayToDecNumber(VOLT, 0, false);
    ...
    case 2:
      switch (MENU_CTU.CV) {
        case 0:
          if ((AUTO_RTRIG.Q || (SCROL_TIMER_INC.Q == HIGH && SCROL_FAST.Q)) && SET_HH < SET_HH_MAX) SET_HH++;
          else if ((START_RTRIG.Q || (SCROL_TIMER_DEC.Q == HIGH && SCROL_FAST.Q)) && SET_HH > SET_HH_MIN) SET_HH--;
          if (SET_HH > SET_HH_MAX) SET_HH = SET_HH_MAX;
          else if (SET_HH < SET_HH_MIN) SET_HH = SET_HH_MIN;
          V_DISP.setDisplayToString("OnS");
          A_DISP.setDisplayToDecNumber(SET_HH, 0, false);
          break;
        case 1:
          if ((AUTO_RTRIG.Q || (SCROL_TIMER_INC.Q == HIGH && SCROL_FAST.Q)) && SET_MM < SET_MM_MAX) SET_MM++;
          else if ((START_RTRIG.Q || (SCROL_TIMER_DEC.Q == HIGH && SCROL_FAST.Q)) && SET_MM > SET_MM_MIN) SET_MM--;
          if (SET_MM > SET_MM_MAX) SET_MM = SET_MM_MAX;
          else if (SET_MM < SET_MM_MIN) SET_MM = SET_MM_MIN;
          V_DISP.setDisplayToString("OFS");
          A_DISP.setDisplayToDecNumber(SET_MM, 0, false);
          break;
        case 2:
